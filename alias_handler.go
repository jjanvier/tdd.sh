...
type AliasHandlerI interface {
	HandleAlias(conf Configuration, alias string) (ExecutionResult, error)
}
...
func (handler AliasHandler) HandleAlias(conf Configuration, alias string) (ExecutionResult, error) {
